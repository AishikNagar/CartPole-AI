...
# USEFUL READ: https://medium.com/@awjuliani/super-simple-reinforcement-learning-tutorial-part-2-ded33892c724
...
with tf.Session() as sess:
    ...
    # Save model if we want to use in another file
    meta_graph_def = tf.train.export_meta_graph(
        filename='my-650-step-policy-model.meta')
    # Save session
    saver.save(sess, 'my-650-step-policy-model')
